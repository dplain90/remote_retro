...
describe("IdeaSubmissionForm component", () => {
  ...
  describe("on submit", () => {
    describe("when in the IDEA_GENERATION stage", () => {
      it("invokes the  passing a happy idea by default", () => {
        const actions = { submitIdeaOptimistically: sinon.spy() }
        ...
        expect(
          actions.submitIdeaOptimistically.calledWith({
            category: "happy",
            body: "",
            userId: 1,
            assigneeId: null,
    ...
    describe("when in the ACTION_ITEMS stage", () => {
      it("invokes the submitIdeaOptimistically action with the action-item", () => {
        const actions = { submitIdeaOptimistically: sinon.spy() }
